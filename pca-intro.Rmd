...
```{r}
pca <- prcomp(mtcars, center = TRUE, scale. = FALSE)
```
...
corresponds to `pca$x`) for the first two components, and color the points by
...
components, it is nowhere near as dominant as before.
